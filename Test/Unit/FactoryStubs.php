...
// Note: the DLQ `DeadLetterEntryInterfaceFactory` and
// `Model\ResourceModel\DeadLetterEntry\CollectionFactory` stubs were removed
// here — both are now shipped as real hand-written classes in the module
// (`Api/Data/DeadLetterEntryInterfaceFactory.php` and
// `Model/ResourceModel/DeadLetterEntry/CollectionFactory.php`) so the DLQ
// tests (BUG-SHIPPINGCORE-DLQ-TEST-1 fix) work with or without this
// bootstrap being loaded.
